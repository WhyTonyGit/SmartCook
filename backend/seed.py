...
def seed_recipes(reset=False):
    ...
    recipes_data = [
        ...
        {
            'title': 'Свинина с овощами на сковороде',
            'description': 'Сочные кусочки свинины с овощами и соевым соусом.',
            'cooking_time': 30,
            'difficulty': Difficulty.EASY,
            'image_query': 'pork stir fry',
            'categories': ['Обеды', 'Ужины', 'Мясо'],
            'ingredients': ['свинина', 'лук', 'морковь', 'болгарский перец', 'чеснок', 'соевый соус', 'соль'],
            'steps': [
                ('Подготовка', 'Нарежьте свинину полосками, овощи — соломкой.'),
                ('Обжарка мяса', 'Обжарьте свинину до румяной корочки.'),
                ('Овощи', 'Добавьте лук и морковь, готовьте 3–4 минуты.'),
                ('Перец', 'Всыпьте болгарский перец и обжарьте ещё 3 минуты.'),
                ('Соус', 'Добавьте чеснок и соевый соус, перемешайте.'),
                ('Подача', 'Посолите по вкусу и подавайте горячим.')
            ]
        },
        {
            'title': 'Тушёная баранина с картофелем',
            'description': 'Нежная баранина с картофелем и ароматной подливкой.',
            'cooking_time': 75,
            'difficulty': Difficulty.MEDIUM,
            'image_query': 'lamb stew',
            'categories': ['Обеды', 'Мясо'],
            'ingredients': ['баранина', 'картофель', 'морковь', 'лук', 'чеснок', 'томатная паста', 'соль'],
            'steps': [
                ('Подготовка', 'Нарежьте баранину крупными кусочками, овощи — кубиком.'),
                ('Обжарка', 'Обжарьте баранину до румяности.'),
                ('Овощи', 'Добавьте лук и морковь, тушите 5 минут.'),
                ('Паста', 'Вмешайте томатную пасту и чеснок.'),
                ('Картофель', 'Добавьте картофель и залейте водой.'),
                ('Томление', 'Тушите под крышкой 40 минут до мягкости.'),
                ('Подача', 'Посолите и подавайте с зеленью.')
            ]
        },
        {
            'title': 'Кролик в сметанном соусе',
            'description': 'Нежное мясо кролика, томлёное в сметанном соусе.',
            'cooking_time': 70,
            'difficulty': Difficulty.MEDIUM,
            'image_query': 'rabbit stew',
            'categories': ['Ужины', 'Мясо'],
            'ingredients': ['кролик', 'сметана', 'лук', 'морковь', 'чеснок', 'соль'],
            'steps': [
                ('Подготовка', 'Нарежьте кролика порционными кусочками.'),
                ('Обжарка', 'Обжарьте кролика до золотистой корочки.'),
                ('Овощи', 'Добавьте лук и морковь, готовьте 5 минут.'),
                ('Соус', 'Вмешайте сметану и чеснок, посолите.'),
                ('Томление', 'Тушите под крышкой 40 минут на слабом огне.'),
                ('Подача', 'Подавайте с гарниром по вкусу.')
            ]
        },
        {
            'title': 'Рыбные котлеты',
            'description': 'Домашние котлеты из белой рыбы с зеленью.',
            'cooking_time': 35,
            'difficulty': Difficulty.EASY,
            'image_query': 'fish cakes',
            'categories': ['Ужины', 'Обеды'],
            'ingredients': ['рыба', 'яйца', 'лук', 'сухари', 'зелень', 'соль'],
            'steps': [
                ('Фарш', 'Пропустите рыбу и лук через мясорубку.'),
                ('Смешивание', 'Добавьте яйцо, зелень и сухари, посолите.'),
                ('Формование', 'Сформируйте котлеты влажными руками.'),
                ('Жарка', 'Обжарьте котлеты по 3–4 минуты с каждой стороны.'),
                ('Готовность', 'Доведите до готовности под крышкой ещё 3 минуты.'),
                ('Подача', 'Подавайте с гарниром и соусом.')
            ]
        },
        {
            'title': 'Салат с тунцом и яйцом',
            'description': 'Лёгкий салат с тунцом, яйцом и свежими овощами.',
            'cooking_time': 15,
            'difficulty': Difficulty.EASY,
            'image_query': 'tuna salad',
            'categories': ['Салаты'],
            'ingredients': ['тунец', 'листовой салат', 'черри', 'огурцы', 'яйца', 'оливковое масло', 'лимон'],
            'steps': [
                ('Подготовка', 'Отварите яйца и нарежьте их четвертинками.'),
                ('Овощи', 'Нарежьте огурцы и черри.'),
                ('Основа', 'Разложите салатные листья на тарелке.'),
                ('Тунец', 'Добавьте тунец и овощи.'),
                ('Заправка', 'Смешайте масло с лимонным соком.'),
                ('Подача', 'Полейте салат заправкой и подавайте.')
            ]
        },
        {
            'title': 'Треска с лимоном в духовке',
            'description': 'Запечённая треска с лимоном и чесноком.',
            'cooking_time': 25,
            'difficulty': Difficulty.EASY,
            'image_query': 'baked cod',
            'categories': ['Ужины', 'Обеды'],
            'ingredients': ['треска', 'лимон', 'оливковое масло', 'чеснок', 'соль'],
            'steps': [
                ('Подготовка', 'Разогрейте духовку до 190°C.'),
                ('Маринад', 'Смешайте масло, лимонный сок и чеснок.'),
                ('Запекание', 'Смажьте треску маринадом и выложите в форму.'),
                ('Готовка', 'Запекайте 12–15 минут до готовности.'),
                ('Подача', 'Подавайте с дольками лимона.')
            ]
        },
        {
            'title': 'Кальмар в сливочно-чесночном соусе',
            'description': 'Нежные кольца кальмара в сливочном соусе.',
            'cooking_time': 20,
            'difficulty': Difficulty.EASY,
            'image_query': 'squid in cream sauce',
            'categories': ['Ужины', 'Обеды'],
            'ingredients': ['кальмар', 'сливки', 'чеснок', 'оливковое масло', 'соль'],
            'steps': [
                ('Подготовка', 'Нарежьте кальмары кольцами и обсушите.'),
                ('Обжарка', 'Быстро обжарьте кальмары 1–2 минуты.'),
                ('Соус', 'Добавьте чеснок и влейте сливки.'),
                ('Томление', 'Прогрейте соус 3–4 минуты, не доводя до кипения.'),
                ('Подача', 'Посолите и подавайте сразу.')
            ]
        }
    ]
